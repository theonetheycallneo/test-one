...
function getQualifiedRouteComponent(value) {
  ...
  ScreenComponent = React.forwardRef((props, ref) => {
    ...
    /* @__PURE__ */ jsx(Component, { ...props, ref });
  });
  const wrapSuspense = (children) => children, getLoadable = (props, ref) => /* @__PURE__ */ jsx(RootErrorBoundary, { children: wrapSuspense(
    /* @__PURE__ */ jsx(
      ScreenComponent,
      {
        ...props,
  ...
  ) }), SuspenseFallback = ({ route }) => (useEffect(() => {
  }, [route]), null), QualifiedRoute = React.forwardRef(
    ({
