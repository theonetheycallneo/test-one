...
function createApp(options) {
  return import.meta.env.SSR ? {
    options,
    render: async (props) => {
      let html = await renderToString(/* @__PURE__ */ jsx(Root, { routes: options.routes, ...props }), {
    ...
    resolveClientLoader({
      ...
      render(/* @__PURE__ */ jsx(Root, { isClient: !0, routes: options.routes, path: window.location.href }));
    }).catch((err) => {
