...
import { matchDeepDynamicRouteName, matchDynamicName, matchGroupName, testNotFound } from "../matchers.mjs";
...
function getPathDataFromState(state, _options = {
  ...
  if (validatePathConfig(options), Object.is(options.screens, DEFAULT_SCREENS)) throw Error("You must pass a 'screens' object to 'getPathFromState' to generate a path.");
...
export { appendBaseUrl, deepEqual, getPathFromState as default, getPathDataFromState };
