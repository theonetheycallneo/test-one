...
function Root(props) {
  ...
  return loaderData?.constructor?.name === "QueryImpl" && (loaderData = void 0), /* @__PURE__ */ jsxs("html", { lang: "en-US", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      process.env.NODE_ENV === "development" ? /* @__PURE__ */ jsx(DevHead, {}) : null,
      /* @__PURE__ */ jsx(
        "script",
        {
...
function DevHead() {
  return /* @__PURE__ */ jsxs(Fragment2, { children: [
    /* @__PURE__ */ jsx("link", { rel: "preload", href: ssrCSSID, as: "style" }),
    /* @__PURE__ */ jsx("link", { rel: "stylesheet", href: ssrCSSID, "data-ssr-css": !0 }),
    /* @__PURE__ */ jsx(
      "script",
      {
        type: "module",
