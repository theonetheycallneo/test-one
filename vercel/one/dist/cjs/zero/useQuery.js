...
var import_react = require("react"), import_getQueryKey = require("./getQueryKey"), import_resolveQuery = require("./resolveQuery"), import_useQueryZero = require("./useQueryZero");
...
const promises = /* @__PURE__ */ new WeakMap(), useQuery = (query, enable = !0) => {
  const snapshot = (0, import_useQueryZero.useQuery)(query, enable), queryIdRef = (0, import_react.useRef)();
