...
var import_react_native = require("react-native"), import_getPathFromState = require("../fork/getPathFromState"), import_router = require("../router/router"), import_matchers = require("../matchers");
function eventShouldPreventDefault(e) {
  return e != null && e.defaultPrevented ? !1 : (
    ...
    [
      ...
      "",
      "self"
    ].includes(e.currentTarget.target))
  );
}
function useLinkTo(props) {
  var { linkTo } = (0, import_router.useOneRouter)(), onPress = function(e) {
    var event = props.replace ? "REPLACE" : "PUSH", shouldHandle = !1;
