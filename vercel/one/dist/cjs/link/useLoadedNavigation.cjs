...
function useLoadedNavigation() {
  const {
    ...
    navigation = (0, import_native.useNavigation)(),
    isMounted = (0, import_react.useRef)(!0),
    pending = (0, import_react.useRef)([]);
  ...
  }, [flush, navigationRef]), (0, import_react.useCallback)(fn => {
    pending.current.push(fn), navigationRef.current && flush();
  }, [flush, navigationRef]);
}
function useOptionalNavigation() {
  const [navigation, setNavigation] = (0, import_react.useState)(null),
