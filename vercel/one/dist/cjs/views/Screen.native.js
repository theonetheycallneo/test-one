...
var import_use_isomorphic_layout_effect = require("@vxrn/use-isomorphic-layout-effect"), import_useNavigation = require("../useNavigation");
function Screen(param) {
  var { name, options } = param, navigation = (0, import_useNavigation.useNavigation)(name);
