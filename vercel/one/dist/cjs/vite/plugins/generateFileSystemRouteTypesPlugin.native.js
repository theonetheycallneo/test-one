...
function generateFileSystemRouteTypesPlugin(options) {
  return {
    ...
    configureServer(server) {
      var appDir = (0, import_node_path.join)(process.cwd(), "app"), outFile = (0, import_node_path.join)(process.cwd(), "routes.d.ts"), fileWatcherChangeListener = (0, import_perfect_debounce.debounce)(async function(type, path) {
